	...
	public render() {
		return (
			<div className="sponsors-page">
				<PageTitle image="stock/k.jpg" verticalPosition={35}>Sponsors</PageTitle>

				<div className="container">
					{sponsors.map(company => <Sponsor key={company.name} company={company} />)}
					...
					<div className="row wrap align-center foot">
						...
						<div className="prev-link">
							<ArrowedLink to="/sponsors/previous">See sponsors from previous years</ArrowedLink>
						</div>
					</div>
				</div>
			</div>
